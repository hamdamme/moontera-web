          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              ...
              >
                ...
                <h3 className="mt-4 text-2xl font-bold">{item}</h3>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="px-6 py-24 lg:px-10">
        <div className="mx-auto max-w-7xl rounded-[2rem] bg-blue-600 px-8 py-16 text-center text-white shadow-xl">
          <h2 className="text-4xl font-bold tracking-tight md:text-5xl">
            Ready to drive with Moontera LLC?
          </h2>

          <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-blue-100">
            Contact us today and our team will follow up with the next steps.
          </p>
